...
export type AfterPatchCallback = (patchedJson: JSONValue, patchedState: DocumentState) => {
    json?: JSONValue;
    state?: DocumentState;
};
...
export type OnRenderMenu = (mode: 'tree' | 'text' | 'table', items: MenuItem[]) => MenuItem[] | undefined;
