...
<script>import { faArrowRightArrowLeft, faCaretSquareDown, faCaretSquareUp, faClone, faCopy, faCropAlt, faCut, faFilter, faPaste, faPen, faPlus, faSortAmountDownAlt, faTimes } from '@fortawesome/free-solid-svg-icons';
import { compileJSONPointer, getIn } from 'immutable-json-patch';
import { initial, isEmpty } from 'lodash-es';
import { canConvert, isKeySelection, isMultiSelection, isValueSelection, singleItemSelected } from '../../../../logic/selection';
