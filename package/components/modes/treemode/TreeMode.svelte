...
import { CONTEXT_MENU_HEIGHT, CONTEXT_MENU_WIDTH, MAX_SEARCH_RESULTS, SCROLL_DURATION, SEARCH_UPDATE_THROTTLE, SIMPLE_MODAL_OPTIONS } from '../../../constants';
import { collapsePath, createDocumentState, documentStatePatch, expandAll, expandMinimal, expandPath, expandRecursive, expandSection, expandSingleItem, expandWithCallback, getDefaultExpand, getEnforceString, setEnforceString } from '../../../logic/documentState';
import { createHistory } from '../../../logic/history';
import { duplicate, extract, revertJSONPatchWithMoveOperations } from '../../../logic/operations';
...
import { canConvert, createAfterSelection, createInsideSelection, createKeySelection, createMultiSelection, createSelectionFromOperations, createValueSelection, findRootPath, getInitialSelection, getSelectionDown, getSelectionLeft, getSelectionNextInside, getSelectionPaths, getSelectionRight, getSelectionUp, hasSelectionContents, isEditingSelection, isMultiSelection, isSelectionInsidePath, isValueSelection, removeEditModeFromSelection, selectAll, updateSelectionInDocumentState } from '../../../logic/selection';
import { mapValidationErrors, validateJSON } from '../../../logic/validation';
import { activeElementIsChildOf, createNormalizationFunctions, encodeDataPath, findParentWithNodeName, getWindow, isChildOf, isChildOfNodeName } from '../../../utils/domUtils';
import { convertValue, normalizeJsonParseError, parsePartialJson, repairPartialJson } from '../../../utils/jsonUtils';
import { keyComboFromEvent } from '../../../utils/keyBindings';
import { isObjectOrArray, isUrl, stringConvert } from '../../../utils/typeUtils';
...
import { onCopy, onCut, onInsert, onInsertCharacter, onPaste, onRemove } from '../../../logic/actions';
...
function applySearch(searchText, json) {
    if (searchText === '') {
