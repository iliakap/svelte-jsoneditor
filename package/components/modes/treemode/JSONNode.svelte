...
import { getEnforceString, getVisibleCaretPositions } from '../../../logic/documentState';
import { rename } from '../../../logic/operations';
import { createAfterSelection, createInsideSelection, createMultiSelection, fromCaretPosition, fromSelectionType, getEndPath, getSelectionPaths, getStartPath, isAfterSelection, isInsideSelection, isKeySelection, isMultiSelection, isPathInsideSelection, isValueSelection, selectionIfOverlapping } from '../../../logic/selection';
...
:global(.jse-main:not(.jse-focus)) .jse-json-node .jse-insert-area.jse-selected :global(.jse-context-menu-pointer) {
  background: var(--jse-selection-background-color);
}
:global(.jse-main:not(.jse-focus)) .jse-json-node .jse-insert-area.jse-selected :global(.jse-context-menu-pointer):hover {
  background: var(--jse-selection-background-color);
}
