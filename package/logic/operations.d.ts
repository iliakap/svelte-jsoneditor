import { type JSONPatchDocument, type JSONPatchOperation, type JSONPath, type JSONValue } from 'immutable-json-patch';
 ...
 */
export declare function createNestedValueOperations(operations: JSONPatchOperation[], json: JSONValue): (import("immutable-json-patch").JSONPatchAdd | import("immutable-json-patch").JSONPatchRemove | import("immutable-json-patch").JSONPatchReplace | import("immutable-json-patch").JSONPatchCopy | import("immutable-json-patch").JSONPatchMove | import("immutable-json-patch").JSONPatchTest)[];
