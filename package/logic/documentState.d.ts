 ...
 */
export declare function expandWithCallback(json: JSONValue, documentState: DocumentState, path: JSONPath, expandedCallback: OnExpand): DocumentState;
 ...
 */
export declare function expandRecursive(json: JSONValue, documentState: DocumentState, path: JSONPath): DocumentState;
export declare function expandMinimal(path: JSONPath): boolean;
export declare function expandAll(): boolean;
export declare function getDefaultExpand(json: JSONValue): OnExpand;
export {};
